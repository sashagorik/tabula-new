 ...
 */
export type SwitchInlineQueryFunction = (query: string, chatType: 'users' | 'bots' | 'groups' | 'channels') => void;
/**
 ...
 * @group Hooks
 */
declare const useSwitchInlineQuery: () => SwitchInlineQueryFunction;
